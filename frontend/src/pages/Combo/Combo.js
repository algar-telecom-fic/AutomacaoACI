    ...
    <div className="row m-5 pb-5 px-5 bg-light rounded text-center">
      ...
      <>
        <DataTable
          ...
          selection={getSelectedCombo}
          onSelectionChange={(e) => setSelectedCombo(e.value)}
          dataKey="id"
        >
        ...
        <div className="d-flex p-0 mx-auto mt-2" style={{ width: "50%" }}>
          <button className="btn d-block btn-success mx-auto mt-2" style={{ width: "50%" }} onClick={confirmStart}>
            Start
          </button>
        </div>
      </>

...
const AP = (props) => {
    ...
    async function handleSubmit(event){
        ...
        await api.post('/ap', {ApParam: data}).then(response => {
        ...
        <div className={getStyle}>
            ...
            <form onSubmit={handleSubmit}>
                <div className="col-md-6 mx-auto">
                    ...
                    <Select className="col-sm-12 mx-auto" defaultValue={tenantVrfOptions} options={tenantVrfOptions} onChange={e => setTenant(e.value)}/>

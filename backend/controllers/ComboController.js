...
const json2yaml = 'json2yaml ./ansible/json/vars.json > ./ansible/yml/vars.yml && ansible-playbook -i ./ansible/yml/hosts ./ansible/yml/combo1_ip.yml'; //converte JSON->YAML & EXECUTA COMANDO ANSIBLE

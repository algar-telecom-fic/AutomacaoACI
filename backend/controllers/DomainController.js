...
const json2yaml =
  "json2yaml ../ansible/json/vars.json > ../ansible/yml/vars.yml && ansible-playbook -i ../ansible/yml/hosts ../ansible/yml/create_domain_phy.yml"; //converte JSON->YAML & EXECUTA COMANDO ANSIBLE

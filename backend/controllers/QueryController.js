...
const updateQueryTenant =
  "json2yaml ../ansible/json/vars.json > ../ansible/yml/vars.yml ; ansible-playbook -i ../ansible/yml/hosts ../ansible/yml/query_tenants.yml";
const updateQueryAp =
  "json2yaml ../ansible/json/vars.json > ../ansible/yml/vars.yml ; ansible-playbook -i ../ansible/yml/hosts ../ansible/yml/query_aps.yml";
const updateQueryBd =
  "json2yaml ../ansible/json/vars.json > ../ansible/yml/vars.yml ; ansible-playbook -i ../ansible/yml/hosts ../ansible/yml/query_bds.yml";
const updateQueryVrf =
  "json2yaml ../ansible/json/vars.json > ../ansible/yml/vars.yml ; ansible-playbook -i ../ansible/yml/hosts ../ansible/yml/query_vfrs.yml";
const updateQuerySw =
  "json2yaml ../ansible/json/vars.json > ../ansible/yml/vars.yml ; ansible-playbook -i ../ansible/yml/hosts ../ansible/yml/query_swprof.yml";
    ...
    try {
      await exec(updateQueryTenant, { cwd: __dirname }, (err, stdout, stderr) => {
        if (err) {
          ...
          return response
            .status(200)
            .json({ updateQueryTenant: true, statusMessage: "Tenants list has been updated successfully." });
        }
      });
    } catch (err) {
      ...
      if (APParam) {
        ...
        await exec(updateQueryAp, { cwd: __dirname }, (err, stdout, stderr) => {
          if (err) {
            ...
            return response
              .status(200)
              .json({ updateQueryAp: true, statusMessage: "AP list has been updated successfully." });
          }
        });
      } else {
      ...
      if (BDParam) {
        ...
        await exec(updateQueryBd, { cwd: __dirname }, (err, stdout, stderr) => {
          if (err) {
            ...
            return response
              .status(200)
              .json({ updateQueryBd: true, statusMessage: "BD list has been updated successfully." });
          }
        });
      } else {
      ...
      if (VRFParam) {
        ...
        await exec(updateQueryVrf, { cwd: __dirname }, (err, stdout, stderr) => {
          if (err) {
            ...
            return response
              .status(200)
              .json({ updateQueryVrf: true, statusMessage: "VRF list has been updated successfully." });
          }
        });
      } else {
    ...
    try {
      ...
      if (SwProfParam) {
        ...
        fs.writeFileSync(
          ...
          JSON.stringify({ site_id: SwProfParam.siteId, sw_id: SwProfParam.swId }, null, 2)
        ...
        await exec(updateQuerySw, { cwd: __dirname }, (err, stdout, stderr) => {
          if (err) {
            ...
            return response
              .status(200)
              .json({ updateQuerySwProf: true, statusMessage: "Switch Profile list has been updated successfully." });
          }
        });
      } else {
